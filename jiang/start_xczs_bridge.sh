...
if ! "$PYTHON_BIN" -c \
    "import aiohttp, rclpy, zenoh; from PIL import Image; from xczs_inspection_robot_control.action import PressCabinetButton; from xczs_inspection_robot_control.msg import CabinetControlCatalog" \
    2>/dev/null; then
