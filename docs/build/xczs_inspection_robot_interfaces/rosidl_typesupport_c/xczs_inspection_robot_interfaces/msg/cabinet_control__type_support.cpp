...
static const _CabinetControl_type_support_symbol_names_t _CabinetControl_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xczs_inspection_robot_interfaces, msg, CabinetControl)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xczs_inspection_robot_interfaces, msg, CabinetControl)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, xczs_inspection_robot_interfaces, msg, CabinetControl)() {
  return &::xczs_inspection_robot_interfaces::msg::rosidl_typesupport_c::CabinetControl_message_type_support_handle;
}
