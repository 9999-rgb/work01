...
static const _CabinetControlState_type_support_symbol_names_t _CabinetControlState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xczs_inspection_robot_interfaces, msg, CabinetControlState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xczs_inspection_robot_interfaces, msg, CabinetControlState)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, xczs_inspection_robot_interfaces, msg, CabinetControlState)() {
  return &::xczs_inspection_robot_interfaces::msg::rosidl_typesupport_c::CabinetControlState_message_type_support_handle;
}
