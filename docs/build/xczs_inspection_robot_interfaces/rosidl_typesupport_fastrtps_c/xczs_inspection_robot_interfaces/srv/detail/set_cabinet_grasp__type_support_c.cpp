...
#include "xczs_inspection_robot_interfaces/srv/detail/set_cabinet_grasp__rosidl_typesupport_fastrtps_c.h"
...
using _SetCabinetGrasp_Request__ros_msg_type = xczs_inspection_robot_interfaces__srv__SetCabinetGrasp_Request;
...
size_t get_serialized_size_xczs_inspection_robot_interfaces__srv__SetCabinetGrasp_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetCabinetGrasp_Request__ros_msg_type * ros_message = static_cast<const _SetCabinetGrasp_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _SetCabinetGrasp_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_xczs_inspection_robot_interfaces__srv__SetCabinetGrasp_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xczs_inspection_robot_interfaces
size_t max_serialized_size_xczs_inspection_robot_interfaces__srv__SetCabinetGrasp_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = xczs_inspection_robot_interfaces__srv__SetCabinetGrasp_Request;
    is_plain =
      (
...
static size_t _SetCabinetGrasp_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_xczs_inspection_robot_interfaces__srv__SetCabinetGrasp_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xczs_inspection_robot_interfaces, srv, SetCabinetGrasp_Request)() {
...
using _SetCabinetGrasp_Response__ros_msg_type = xczs_inspection_robot_interfaces__srv__SetCabinetGrasp_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xczs_inspection_robot_interfaces
size_t get_serialized_size_xczs_inspection_robot_interfaces__srv__SetCabinetGrasp_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetCabinetGrasp_Response__ros_msg_type * ros_message = static_cast<const _SetCabinetGrasp_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_xczs_inspection_robot_interfaces__srv__SetCabinetGrasp_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xczs_inspection_robot_interfaces
size_t max_serialized_size_xczs_inspection_robot_interfaces__srv__SetCabinetGrasp_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = xczs_inspection_robot_interfaces__srv__SetCabinetGrasp_Response;
    is_plain =
      (
...
static size_t _SetCabinetGrasp_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_xczs_inspection_robot_interfaces__srv__SetCabinetGrasp_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xczs_inspection_robot_interfaces, srv, SetCabinetGrasp_Response)() {
...
// already included above
// #include "xczs_inspection_robot_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "xczs_inspection_robot_interfaces/srv/set_cabinet_grasp.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xczs_inspection_robot_interfaces, srv, SetCabinetGrasp)() {
