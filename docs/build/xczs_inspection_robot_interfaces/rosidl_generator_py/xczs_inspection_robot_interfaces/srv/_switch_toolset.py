...
class Metaclass_SwitchToolset(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'xczs_inspection_robot_interfaces.srv.SwitchToolset')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from xczs_inspection_robot_interfaces.srv import _switch_toolset
...
class SwitchToolset(metaclass=Metaclass_SwitchToolset):
    from xczs_inspection_robot_interfaces.srv._switch_toolset import SwitchToolset_Request as Request
    from xczs_inspection_robot_interfaces.srv._switch_toolset import SwitchToolset_Response as Response
