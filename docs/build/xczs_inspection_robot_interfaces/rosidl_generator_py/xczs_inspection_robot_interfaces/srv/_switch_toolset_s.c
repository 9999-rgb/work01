...
bool xczs_inspection_robot_interfaces__srv__switch_toolset__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("xczs_inspection_robot_interfaces.srv._switch_toolset.SwitchToolset_Request", full_classname_dest, 74) == 0);
  }
  xczs_inspection_robot_interfaces__srv__SwitchToolset_Request * ros_message = _ros_message;
  {  // toolset
...
PyObject * xczs_inspection_robot_interfaces__srv__switch_toolset__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("xczs_inspection_robot_interfaces.srv._switch_toolset");
...
ROSIDL_GENERATOR_C_EXPORT
bool xczs_inspection_robot_interfaces__srv__switch_toolset__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("xczs_inspection_robot_interfaces.srv._switch_toolset.SwitchToolset_Response", full_classname_dest, 75) == 0);
  }
  xczs_inspection_robot_interfaces__srv__SwitchToolset_Response * ros_message = _ros_message;
  {  // accepted
