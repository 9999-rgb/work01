...
bool xczs_inspection_robot_interfaces__srv__set_cabinet_grasp__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("xczs_inspection_robot_interfaces.srv._set_cabinet_grasp.SetCabinetGrasp_Request", full_classname_dest, 79) == 0);
  }
  xczs_inspection_robot_interfaces__srv__SetCabinetGrasp_Request * ros_message = _ros_message;
  {  // control_id
...
PyObject * xczs_inspection_robot_interfaces__srv__set_cabinet_grasp__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("xczs_inspection_robot_interfaces.srv._set_cabinet_grasp");
...
ROSIDL_GENERATOR_C_EXPORT
bool xczs_inspection_robot_interfaces__srv__set_cabinet_grasp__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("xczs_inspection_robot_interfaces.srv._set_cabinet_grasp.SetCabinetGrasp_Response", full_classname_dest, 80) == 0);
  }
  xczs_inspection_robot_interfaces__srv__SetCabinetGrasp_Response * ros_message = _ros_message;
  {  // success
