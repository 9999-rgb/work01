...
#include "xczs_inspection_robot_interfaces/srv/detail/switch_toolset__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const xczs_inspection_robot_interfaces::srv::SwitchToolset_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  xczs_inspection_robot_interfaces::srv::SwitchToolset_Request & ros_message)
{
  // Member: toolset
  cdr >> ros_message.toolset;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = xczs_inspection_robot_interfaces::srv::SwitchToolset_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const xczs_inspection_robot_interfaces::srv::SwitchToolset_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<xczs_inspection_robot_interfaces::srv::SwitchToolset_Request *>(
    untyped_ros_message);
...
{
  return &xczs_inspection_robot_interfaces::srv::typesupport_fastrtps_cpp::_SwitchToolset_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xczs_inspection_robot_interfaces, srv, SwitchToolset_Request)() {
  return &xczs_inspection_robot_interfaces::srv::typesupport_fastrtps_cpp::_SwitchToolset_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_xczs_inspection_robot_interfaces
cdr_serialize(
  const xczs_inspection_robot_interfaces::srv::SwitchToolset_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: accepted
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  xczs_inspection_robot_interfaces::srv::SwitchToolset_Response & ros_message)
{
  // Member: accepted
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = xczs_inspection_robot_interfaces::srv::SwitchToolset_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const xczs_inspection_robot_interfaces::srv::SwitchToolset_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<xczs_inspection_robot_interfaces::srv::SwitchToolset_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &xczs_inspection_robot_interfaces::srv::typesupport_fastrtps_cpp::_SwitchToolset_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xczs_inspection_robot_interfaces, srv, SwitchToolset_Response)() {
  return &xczs_inspection_robot_interfaces::srv::typesupport_fastrtps_cpp::_SwitchToolset_Response__handle;
}
...
{
  return &xczs_inspection_robot_interfaces::srv::typesupport_fastrtps_cpp::_SwitchToolset__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xczs_inspection_robot_interfaces, srv, SwitchToolset)() {
  return &xczs_inspection_robot_interfaces::srv::typesupport_fastrtps_cpp::_SwitchToolset__handle;
}
