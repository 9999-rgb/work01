...
#include "xczs_inspection_robot_interfaces/msg/detail/cabinet_control__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = xczs_inspection_robot_interfaces::msg::CabinetControl;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const xczs_inspection_robot_interfaces::msg::CabinetControl *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<xczs_inspection_robot_interfaces::msg::CabinetControl *>(
    untyped_ros_message);
...
{
  return &xczs_inspection_robot_interfaces::msg::typesupport_fastrtps_cpp::_CabinetControl__handle;
}
