...
#[link(name = "xczs_inspection_robot_interfaces__rosidl_typesupport_c")]
extern "C" {
    fn rosidl_typesupport_c__get_action_type_support_handle__xczs_inspection_robot_interfaces__action__OperateCabinetControl() -> *const std::ffi::c_void;
}

// Corresponds to xczs_inspection_robot_interfaces__action__OperateCabinetControl
#[allow(missing_docs, non_camel_case_types)]
...
impl rosidl_runtime_rs::Action for OperateCabinetControl {
  ...
  fn get_type_support() -> *const std::ffi::c_void {
    // SAFETY: No preconditions for this function.
    unsafe { rosidl_typesupport_c__get_action_type_support_handle__xczs_inspection_robot_interfaces__action__OperateCabinetControl() }
  }
...
#[link(name = "xczs_inspection_robot_interfaces__rosidl_typesupport_c")]
extern "C" {
    fn rosidl_typesupport_c__get_action_type_support_handle__xczs_inspection_robot_interfaces__action__PressCabinetButton() -> *const std::ffi::c_void;
}

// Corresponds to xczs_inspection_robot_interfaces__action__PressCabinetButton
#[allow(missing_docs, non_camel_case_types)]
...
impl rosidl_runtime_rs::Action for PressCabinetButton {
  ...
  fn get_type_support() -> *const std::ffi::c_void {
    // SAFETY: No preconditions for this function.
    unsafe { rosidl_typesupport_c__get_action_type_support_handle__xczs_inspection_robot_interfaces__action__PressCabinetButton() }
  }
