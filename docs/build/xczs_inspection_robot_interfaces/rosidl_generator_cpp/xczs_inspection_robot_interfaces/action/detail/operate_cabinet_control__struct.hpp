...
#ifndef XCZS_INSPECTION_ROBOT_INTERFACES__ACTION__DETAIL__OPERATE_CABINET_CONTROL__STRUCT_HPP_
#define XCZS_INSPECTION_ROBOT_INTERFACES__ACTION__DETAIL__OPERATE_CABINET_CONTROL__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__xczs_inspection_robot_interfaces__action__OperateCabinetControl_Goal __attribute__((deprecated))
#else
# define DEPRECATED__xczs_inspection_robot_interfaces__action__OperateCabinetControl_Goal __declspec(deprecated)
#endif
...
struct OperateCabinetControl_Goal_
{
  ...
  // pointer types
  using RawPtr =
    xczs_inspection_robot_interfaces::action::OperateCabinetControl_Goal_<ContainerAllocator> *;
  using ConstRawPtr =
    const xczs_inspection_robot_interfaces::action::OperateCabinetControl_Goal_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_Goal_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_Goal_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      xczs_inspection_robot_interfaces::action::OperateCabinetControl_Goal_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_Goal_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_Goal_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_Goal_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_Goal_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__xczs_inspection_robot_interfaces__action__OperateCabinetControl_Goal
    std::shared_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_Goal_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__xczs_inspection_robot_interfaces__action__OperateCabinetControl_Goal
    std::shared_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_Goal_<ContainerAllocator> const>
...
using OperateCabinetControl_Goal =
  xczs_inspection_robot_interfaces::action::OperateCabinetControl_Goal_<std::allocator<void>>;
...
#ifndef _WIN32
# define DEPRECATED__xczs_inspection_robot_interfaces__action__OperateCabinetControl_Result __attribute__((deprecated))
#else
# define DEPRECATED__xczs_inspection_robot_interfaces__action__OperateCabinetControl_Result __declspec(deprecated)
#endif
...
struct OperateCabinetControl_Result_
{
  ...
  // pointer types
  using RawPtr =
    xczs_inspection_robot_interfaces::action::OperateCabinetControl_Result_<ContainerAllocator> *;
  using ConstRawPtr =
    const xczs_inspection_robot_interfaces::action::OperateCabinetControl_Result_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_Result_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_Result_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      xczs_inspection_robot_interfaces::action::OperateCabinetControl_Result_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_Result_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      xczs_inspection_robot_interfaces::action::OperateCabinetControl_Result_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_Result_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_Result_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_Result_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__xczs_inspection_robot_interfaces__action__OperateCabinetControl_Result
    std::shared_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_Result_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__xczs_inspection_robot_interfaces__action__OperateCabinetControl_Result
    std::shared_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_Result_<ContainerAllocator> const>
...
using OperateCabinetControl_Result =
  xczs_inspection_robot_interfaces::action::OperateCabinetControl_Result_<std::allocator<void>>;
...
#ifndef _WIN32
# define DEPRECATED__xczs_inspection_robot_interfaces__action__OperateCabinetControl_Feedback __attribute__((deprecated))
#else
# define DEPRECATED__xczs_inspection_robot_interfaces__action__OperateCabinetControl_Feedback __declspec(deprecated)
#endif
...
struct OperateCabinetControl_Feedback_
{
  ...
  // pointer types
  using RawPtr =
    xczs_inspection_robot_interfaces::action::OperateCabinetControl_Feedback_<ContainerAllocator> *;
  using ConstRawPtr =
    const xczs_inspection_robot_interfaces::action::OperateCabinetControl_Feedback_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_Feedback_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_Feedback_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      xczs_inspection_robot_interfaces::action::OperateCabinetControl_Feedback_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_Feedback_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      xczs_inspection_robot_interfaces::action::OperateCabinetControl_Feedback_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_Feedback_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_Feedback_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_Feedback_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__xczs_inspection_robot_interfaces__action__OperateCabinetControl_Feedback
    std::shared_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_Feedback_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__xczs_inspection_robot_interfaces__action__OperateCabinetControl_Feedback
    std::shared_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_Feedback_<ContainerAllocator> const>
...
using OperateCabinetControl_Feedback =
  xczs_inspection_robot_interfaces::action::OperateCabinetControl_Feedback_<std::allocator<void>>;
...
#ifndef _WIN32
# define DEPRECATED__xczs_inspection_robot_interfaces__action__OperateCabinetControl_SendGoal_Request __attribute__((deprecated))
#else
# define DEPRECATED__xczs_inspection_robot_interfaces__action__OperateCabinetControl_SendGoal_Request __declspec(deprecated)
#endif
...
struct OperateCabinetControl_SendGoal_Request_
{
  ...
  Type & set__goal(
    const xczs_inspection_robot_interfaces::action::OperateCabinetControl_Goal_<ContainerAllocator> & _arg)
  {
    this->goal = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    xczs_inspection_robot_interfaces::action::OperateCabinetControl_SendGoal_Request_<ContainerAllocator> *;
  using ConstRawPtr =
    const xczs_inspection_robot_interfaces::action::OperateCabinetControl_SendGoal_Request_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_SendGoal_Request_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_SendGoal_Request_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      xczs_inspection_robot_interfaces::action::OperateCabinetControl_SendGoal_Request_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_SendGoal_Request_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      xczs_inspection_robot_interfaces::action::OperateCabinetControl_SendGoal_Request_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_SendGoal_Request_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_SendGoal_Request_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_SendGoal_Request_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__xczs_inspection_robot_interfaces__action__OperateCabinetControl_SendGoal_Request
    std::shared_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_SendGoal_Request_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__xczs_inspection_robot_interfaces__action__OperateCabinetControl_SendGoal_Request
    std::shared_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_SendGoal_Request_<ContainerAllocator> const>
...
using OperateCabinetControl_SendGoal_Request =
  xczs_inspection_robot_interfaces::action::OperateCabinetControl_SendGoal_Request_<std::allocator<void>>;
...
#ifndef _WIN32
# define DEPRECATED__xczs_inspection_robot_interfaces__action__OperateCabinetControl_SendGoal_Response __attribute__((deprecated))
#else
# define DEPRECATED__xczs_inspection_robot_interfaces__action__OperateCabinetControl_SendGoal_Response __declspec(deprecated)
#endif
...
struct OperateCabinetControl_SendGoal_Response_
{
  ...
  // pointer types
  using RawPtr =
    xczs_inspection_robot_interfaces::action::OperateCabinetControl_SendGoal_Response_<ContainerAllocator> *;
  using ConstRawPtr =
    const xczs_inspection_robot_interfaces::action::OperateCabinetControl_SendGoal_Response_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_SendGoal_Response_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_SendGoal_Response_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      xczs_inspection_robot_interfaces::action::OperateCabinetControl_SendGoal_Response_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_SendGoal_Response_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      xczs_inspection_robot_interfaces::action::OperateCabinetControl_SendGoal_Response_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_SendGoal_Response_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_SendGoal_Response_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_SendGoal_Response_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__xczs_inspection_robot_interfaces__action__OperateCabinetControl_SendGoal_Response
    std::shared_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_SendGoal_Response_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__xczs_inspection_robot_interfaces__action__OperateCabinetControl_SendGoal_Response
    std::shared_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_SendGoal_Response_<ContainerAllocator> const>
...
using OperateCabinetControl_SendGoal_Response =
  xczs_inspection_robot_interfaces::action::OperateCabinetControl_SendGoal_Response_<std::allocator<void>>;
...
{
  using Request = xczs_inspection_robot_interfaces::action::OperateCabinetControl_SendGoal_Request;
  using Response = xczs_inspection_robot_interfaces::action::OperateCabinetControl_SendGoal_Response;
};
...
#ifndef _WIN32
# define DEPRECATED__xczs_inspection_robot_interfaces__action__OperateCabinetControl_GetResult_Request __attribute__((deprecated))
#else
# define DEPRECATED__xczs_inspection_robot_interfaces__action__OperateCabinetControl_GetResult_Request __declspec(deprecated)
#endif
...
struct OperateCabinetControl_GetResult_Request_
{
  ...
  // pointer types
  using RawPtr =
    xczs_inspection_robot_interfaces::action::OperateCabinetControl_GetResult_Request_<ContainerAllocator> *;
  using ConstRawPtr =
    const xczs_inspection_robot_interfaces::action::OperateCabinetControl_GetResult_Request_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_GetResult_Request_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_GetResult_Request_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      xczs_inspection_robot_interfaces::action::OperateCabinetControl_GetResult_Request_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_GetResult_Request_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      xczs_inspection_robot_interfaces::action::OperateCabinetControl_GetResult_Request_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_GetResult_Request_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_GetResult_Request_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_GetResult_Request_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__xczs_inspection_robot_interfaces__action__OperateCabinetControl_GetResult_Request
    std::shared_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_GetResult_Request_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__xczs_inspection_robot_interfaces__action__OperateCabinetControl_GetResult_Request
    std::shared_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_GetResult_Request_<ContainerAllocator> const>
...
using OperateCabinetControl_GetResult_Request =
  xczs_inspection_robot_interfaces::action::OperateCabinetControl_GetResult_Request_<std::allocator<void>>;
...
#ifndef _WIN32
# define DEPRECATED__xczs_inspection_robot_interfaces__action__OperateCabinetControl_GetResult_Response __attribute__((deprecated))
#else
# define DEPRECATED__xczs_inspection_robot_interfaces__action__OperateCabinetControl_GetResult_Response __declspec(deprecated)
#endif
...
struct OperateCabinetControl_GetResult_Response_
{
  ...
  Type & set__result(
    const xczs_inspection_robot_interfaces::action::OperateCabinetControl_Result_<ContainerAllocator> & _arg)
  {
    this->result = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    xczs_inspection_robot_interfaces::action::OperateCabinetControl_GetResult_Response_<ContainerAllocator> *;
  using ConstRawPtr =
    const xczs_inspection_robot_interfaces::action::OperateCabinetControl_GetResult_Response_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_GetResult_Response_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_GetResult_Response_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      xczs_inspection_robot_interfaces::action::OperateCabinetControl_GetResult_Response_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_GetResult_Response_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      xczs_inspection_robot_interfaces::action::OperateCabinetControl_GetResult_Response_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_GetResult_Response_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_GetResult_Response_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_GetResult_Response_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__xczs_inspection_robot_interfaces__action__OperateCabinetControl_GetResult_Response
    std::shared_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_GetResult_Response_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__xczs_inspection_robot_interfaces__action__OperateCabinetControl_GetResult_Response
    std::shared_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_GetResult_Response_<ContainerAllocator> const>
...
using OperateCabinetControl_GetResult_Response =
  xczs_inspection_robot_interfaces::action::OperateCabinetControl_GetResult_Response_<std::allocator<void>>;
...
{
  using Request = xczs_inspection_robot_interfaces::action::OperateCabinetControl_GetResult_Request;
  using Response = xczs_inspection_robot_interfaces::action::OperateCabinetControl_GetResult_Response;
};
...
#ifndef _WIN32
# define DEPRECATED__xczs_inspection_robot_interfaces__action__OperateCabinetControl_FeedbackMessage __attribute__((deprecated))
#else
# define DEPRECATED__xczs_inspection_robot_interfaces__action__OperateCabinetControl_FeedbackMessage __declspec(deprecated)
#endif
...
struct OperateCabinetControl_FeedbackMessage_
{
  ...
  Type & set__feedback(
    const xczs_inspection_robot_interfaces::action::OperateCabinetControl_Feedback_<ContainerAllocator> & _arg)
  {
    this->feedback = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    xczs_inspection_robot_interfaces::action::OperateCabinetControl_FeedbackMessage_<ContainerAllocator> *;
  using ConstRawPtr =
    const xczs_inspection_robot_interfaces::action::OperateCabinetControl_FeedbackMessage_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_FeedbackMessage_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_FeedbackMessage_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      xczs_inspection_robot_interfaces::action::OperateCabinetControl_FeedbackMessage_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_FeedbackMessage_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      xczs_inspection_robot_interfaces::action::OperateCabinetControl_FeedbackMessage_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_FeedbackMessage_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_FeedbackMessage_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_FeedbackMessage_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__xczs_inspection_robot_interfaces__action__OperateCabinetControl_FeedbackMessage
    std::shared_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_FeedbackMessage_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__xczs_inspection_robot_interfaces__action__OperateCabinetControl_FeedbackMessage
    std::shared_ptr<xczs_inspection_robot_interfaces::action::OperateCabinetControl_FeedbackMessage_<ContainerAllocator> const>
...
using OperateCabinetControl_FeedbackMessage =
  xczs_inspection_robot_interfaces::action::OperateCabinetControl_FeedbackMessage_<std::allocator<void>>;
...
struct OperateCabinetControl
{
  ...
  using Goal = xczs_inspection_robot_interfaces::action::OperateCabinetControl_Goal;
  /// The result message defined in the action definition.
  using Result = xczs_inspection_robot_interfaces::action::OperateCabinetControl_Result;
  /// The feedback message defined in the action definition.
  using Feedback = xczs_inspection_robot_interfaces::action::OperateCabinetControl_Feedback;

  struct Impl
  {
    /// The send_goal service using a wrapped version of the goal message as a request.
    using SendGoalService = xczs_inspection_robot_interfaces::action::OperateCabinetControl_SendGoal;
    /// The get_result service using a wrapped version of the result message as a response.
    using GetResultService = xczs_inspection_robot_interfaces::action::OperateCabinetControl_GetResult;
    /// The feedback message with generic fields which wraps the feedback message.
    using FeedbackMessage = xczs_inspection_robot_interfaces::action::OperateCabinetControl_FeedbackMessage;
...
#endif  // XCZS_INSPECTION_ROBOT_INTERFACES__ACTION__DETAIL__OPERATE_CABINET_CONTROL__STRUCT_HPP_
