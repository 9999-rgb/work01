...
#ifndef XCZS_INSPECTION_ROBOT_INTERFACES__MSG__DETAIL__CABINET_CONTROL_STATE__STRUCT_HPP_
#define XCZS_INSPECTION_ROBOT_INTERFACES__MSG__DETAIL__CABINET_CONTROL_STATE__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__xczs_inspection_robot_interfaces__msg__CabinetControlState __attribute__((deprecated))
#else
# define DEPRECATED__xczs_inspection_robot_interfaces__msg__CabinetControlState __declspec(deprecated)
#endif
...
struct CabinetControlState_
{
  ...
  // pointer types
  using RawPtr =
    xczs_inspection_robot_interfaces::msg::CabinetControlState_<ContainerAllocator> *;
  using ConstRawPtr =
    const xczs_inspection_robot_interfaces::msg::CabinetControlState_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<xczs_inspection_robot_interfaces::msg::CabinetControlState_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<xczs_inspection_robot_interfaces::msg::CabinetControlState_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      xczs_inspection_robot_interfaces::msg::CabinetControlState_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<xczs_inspection_robot_interfaces::msg::CabinetControlState_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<xczs_inspection_robot_interfaces::msg::CabinetControlState_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<xczs_inspection_robot_interfaces::msg::CabinetControlState_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<xczs_inspection_robot_interfaces::msg::CabinetControlState_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__xczs_inspection_robot_interfaces__msg__CabinetControlState
    std::shared_ptr<xczs_inspection_robot_interfaces::msg::CabinetControlState_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__xczs_inspection_robot_interfaces__msg__CabinetControlState
    std::shared_ptr<xczs_inspection_robot_interfaces::msg::CabinetControlState_<ContainerAllocator> const>
...
using CabinetControlState =
  xczs_inspection_robot_interfaces::msg::CabinetControlState_<std::allocator<void>>;
...
#endif  // XCZS_INSPECTION_ROBOT_INTERFACES__MSG__DETAIL__CABINET_CONTROL_STATE__STRUCT_HPP_
