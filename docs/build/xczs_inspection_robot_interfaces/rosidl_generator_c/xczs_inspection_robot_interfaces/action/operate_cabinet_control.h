...
#ifndef XCZS_INSPECTION_ROBOT_INTERFACES__ACTION__OPERATE_CABINET_CONTROL_H_
#define XCZS_INSPECTION_ROBOT_INTERFACES__ACTION__OPERATE_CABINET_CONTROL_H_
...
#endif  // XCZS_INSPECTION_ROBOT_INTERFACES__ACTION__OPERATE_CABINET_CONTROL_H_
