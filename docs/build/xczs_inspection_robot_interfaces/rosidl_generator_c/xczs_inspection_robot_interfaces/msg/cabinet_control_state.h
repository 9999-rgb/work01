...
#ifndef XCZS_INSPECTION_ROBOT_INTERFACES__MSG__CABINET_CONTROL_STATE_H_
#define XCZS_INSPECTION_ROBOT_INTERFACES__MSG__CABINET_CONTROL_STATE_H_
...
#endif  // XCZS_INSPECTION_ROBOT_INTERFACES__MSG__CABINET_CONTROL_STATE_H_
