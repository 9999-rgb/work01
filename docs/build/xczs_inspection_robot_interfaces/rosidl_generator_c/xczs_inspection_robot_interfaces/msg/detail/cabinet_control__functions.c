...
xczs_inspection_robot_interfaces__msg__CabinetControl__init(xczs_inspection_robot_interfaces__msg__CabinetControl * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->control_id)) {
    xczs_inspection_robot_interfaces__msg__CabinetControl__fini(msg);
    return false;
  }
  // display_name
...
xczs_inspection_robot_interfaces__msg__CabinetControl__create()
{
  ...
  xczs_inspection_robot_interfaces__msg__CabinetControl * msg = (xczs_inspection_robot_interfaces__msg__CabinetControl *)allocator.allocate(sizeof(xczs_inspection_robot_interfaces__msg__CabinetControl), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(xczs_inspection_robot_interfaces__msg__CabinetControl));
  bool success = xczs_inspection_robot_interfaces__msg__CabinetControl__init(msg);
  if (!success) {
...
xczs_inspection_robot_interfaces__msg__CabinetControl__Sequence__init(xczs_inspection_robot_interfaces__msg__CabinetControl__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xczs_inspection_robot_interfaces__msg__CabinetControl * data = NULL;

  if (size) {
    data = (xczs_inspection_robot_interfaces__msg__CabinetControl *)allocator.zero_allocate(size, sizeof(xczs_inspection_robot_interfaces__msg__CabinetControl), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = xczs_inspection_robot_interfaces__msg__CabinetControl__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        xczs_inspection_robot_interfaces__msg__CabinetControl__fini(&data[i - 1]);
      }
...
xczs_inspection_robot_interfaces__msg__CabinetControl__Sequence__fini(xczs_inspection_robot_interfaces__msg__CabinetControl__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      xczs_inspection_robot_interfaces__msg__CabinetControl__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xczs_inspection_robot_interfaces__msg__CabinetControl__Sequence * array = (xczs_inspection_robot_interfaces__msg__CabinetControl__Sequence *)allocator.allocate(sizeof(xczs_inspection_robot_interfaces__msg__CabinetControl__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = xczs_inspection_robot_interfaces__msg__CabinetControl__Sequence__init(array, size);
  if (!success) {
...
xczs_inspection_robot_interfaces__msg__CabinetControl__Sequence__destroy(xczs_inspection_robot_interfaces__msg__CabinetControl__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    xczs_inspection_robot_interfaces__msg__CabinetControl__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
xczs_inspection_robot_interfaces__msg__CabinetControl__Sequence__are_equal(const xczs_inspection_robot_interfaces__msg__CabinetControl__Sequence * lhs, const xczs_inspection_robot_interfaces__msg__CabinetControl__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!xczs_inspection_robot_interfaces__msg__CabinetControl__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  xczs_inspection_robot_interfaces__msg__CabinetControl__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(xczs_inspection_robot_interfaces__msg__CabinetControl);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    xczs_inspection_robot_interfaces__msg__CabinetControl * data =
      (xczs_inspection_robot_interfaces__msg__CabinetControl *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!xczs_inspection_robot_interfaces__msg__CabinetControl__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          xczs_inspection_robot_interfaces__msg__CabinetControl__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!xczs_inspection_robot_interfaces__msg__CabinetControl__copy(
