...
{
  new (message_memory) xczs_inspection_robot_control::msg::CabinetControlCatalog(_init);
}

void CabinetControlCatalog_fini_function(void * message_memory)
{
  auto typed_message = static_cast<xczs_inspection_robot_control::msg::CabinetControlCatalog *>(message_memory);
  typed_message->~CabinetControlCatalog();
}

size_t size_function__CabinetControlCatalog__controls(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<xczs_inspection_robot_control::msg::CabinetControl> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<xczs_inspection_robot_control::msg::CabinetControl> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<xczs_inspection_robot_control::msg::CabinetControl> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const xczs_inspection_robot_control::msg::CabinetControl *>(
    get_const_function__CabinetControlCatalog__controls(untyped_member, index));
  auto & value = *reinterpret_cast<xczs_inspection_robot_control::msg::CabinetControl *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<xczs_inspection_robot_control::msg::CabinetControl *>(
    get_function__CabinetControlCatalog__controls(untyped_member, index));
  const auto & value = *reinterpret_cast<const xczs_inspection_robot_control::msg::CabinetControl *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CabinetControlCatalog_message_member_array[1] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<xczs_inspection_robot_control::msg::CabinetControl>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(xczs_inspection_robot_control::msg::CabinetControlCatalog, controls),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers CabinetControlCatalog_message_members = {
  ...
  1,  // number of fields
  sizeof(xczs_inspection_robot_control::msg::CabinetControlCatalog),
...
{
  return &::xczs_inspection_robot_control::msg::rosidl_typesupport_introspection_cpp::CabinetControlCatalog_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, xczs_inspection_robot_control, msg, CabinetControlCatalog)() {
  return &::xczs_inspection_robot_control::msg::rosidl_typesupport_introspection_cpp::CabinetControlCatalog_message_type_support_handle;
}
