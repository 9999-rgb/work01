...
#ifndef XCZS_INSPECTION_ROBOT_CONTROL__MSG__DETAIL__CABINET_CONTROL__STRUCT_H_
#define XCZS_INSPECTION_ROBOT_CONTROL__MSG__DETAIL__CABINET_CONTROL__STRUCT_H_
...
enum
{
  xczs_inspection_robot_control__msg__CabinetControl__TYPE_BUTTON = 0
};

/// Constant 'TYPE_KNOB'.
enum
{
  xczs_inspection_robot_control__msg__CabinetControl__TYPE_KNOB = 1
};

/// Constant 'TYPE_SWITCH'.
enum
{
  xczs_inspection_robot_control__msg__CabinetControl__TYPE_SWITCH = 2
};

/// Constant 'TYPE_DOOR'.
enum
{
  xczs_inspection_robot_control__msg__CabinetControl__TYPE_DOOR = 3
};

/// Constant 'SUPPORT_PRESS'.
enum
{
  xczs_inspection_robot_control__msg__CabinetControl__SUPPORT_PRESS = 1
};

/// Constant 'SUPPORT_SET_STATE'.
enum
{
  xczs_inspection_robot_control__msg__CabinetControl__SUPPORT_SET_STATE = 2
};

/// Constant 'SUPPORT_SET_POSITION'.
enum
{
  xczs_inspection_robot_control__msg__CabinetControl__SUPPORT_SET_POSITION = 4
};

/// Constant 'SUPPORT_TOGGLE'.
enum
{
  xczs_inspection_robot_control__msg__CabinetControl__SUPPORT_TOGGLE = 8
};
...
/// Struct defined in msg/CabinetControl in the package xczs_inspection_robot_control.
typedef struct xczs_inspection_robot_control__msg__CabinetControl
{
...
// Struct for a sequence of xczs_inspection_robot_control__msg__CabinetControl.
typedef struct xczs_inspection_robot_control__msg__CabinetControl__Sequence
{
...
#endif  // XCZS_INSPECTION_ROBOT_CONTROL__MSG__DETAIL__CABINET_CONTROL__STRUCT_H_
