...
#ifndef XCZS_INSPECTION_ROBOT_CONTROL__SRV__DETAIL__MANAGE_OPERATION_LEASE__FUNCTIONS_H_
#define XCZS_INSPECTION_ROBOT_CONTROL__SRV__DETAIL__MANAGE_OPERATION_LEASE__FUNCTIONS_H_
 ...
 * calls
 * xczs_inspection_robot_control__srv__ManageOperationLease_Request__init().
...
/**
 * It calls
 * xczs_inspection_robot_control__srv__ManageOperationLease_Request__fini()
 ...
 * xczs_inspection_robot_control__srv__ManageOperationLease_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * xczs_inspection_robot_control__srv__ManageOperationLease_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * xczs_inspection_robot_control__srv__ManageOperationLease_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_xczs_inspection_robot_control
...
/**
 * It calls
 * xczs_inspection_robot_control__srv__ManageOperationLease_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_xczs_inspection_robot_control
...
/**
 * It allocates the memory for the array and calls
 * xczs_inspection_robot_control__srv__ManageOperationLease_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_xczs_inspection_robot_control
...
/**
 * It calls
 * xczs_inspection_robot_control__srv__ManageOperationLease_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // XCZS_INSPECTION_ROBOT_CONTROL__SRV__DETAIL__MANAGE_OPERATION_LEASE__FUNCTIONS_H_
