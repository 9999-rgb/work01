...
#include "xczs_inspection_robot_control/msg/detail/cabinet_control_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const xczs_inspection_robot_control::msg::CabinetControlState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  xczs_inspection_robot_control::msg::CabinetControlState & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = xczs_inspection_robot_control::msg::CabinetControlState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const xczs_inspection_robot_control::msg::CabinetControlState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<xczs_inspection_robot_control::msg::CabinetControlState *>(
    untyped_ros_message);
...
get_message_type_support_handle<xczs_inspection_robot_control::msg::CabinetControlState>()
{
  return &xczs_inspection_robot_control::msg::typesupport_fastrtps_cpp::_CabinetControlState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xczs_inspection_robot_control, msg, CabinetControlState)() {
  return &xczs_inspection_robot_control::msg::typesupport_fastrtps_cpp::_CabinetControlState__handle;
}
