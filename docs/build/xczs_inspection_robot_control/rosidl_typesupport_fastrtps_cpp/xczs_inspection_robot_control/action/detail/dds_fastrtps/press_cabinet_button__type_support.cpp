...
#include "xczs_inspection_robot_control/action/detail/press_cabinet_button__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const xczs_inspection_robot_control::action::PressCabinetButton_Goal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  xczs_inspection_robot_control::action::PressCabinetButton_Goal & ros_message)
{
  // Member: button_id
  cdr >> ros_message.button_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = xczs_inspection_robot_control::action::PressCabinetButton_Goal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const xczs_inspection_robot_control::action::PressCabinetButton_Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<xczs_inspection_robot_control::action::PressCabinetButton_Goal *>(
    untyped_ros_message);
...
{
  return &xczs_inspection_robot_control::action::typesupport_fastrtps_cpp::_PressCabinetButton_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xczs_inspection_robot_control, action, PressCabinetButton_Goal)() {
  return &xczs_inspection_robot_control::action::typesupport_fastrtps_cpp::_PressCabinetButton_Goal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_xczs_inspection_robot_control
cdr_serialize(
  const xczs_inspection_robot_control::action::PressCabinetButton_Result & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  xczs_inspection_robot_control::action::PressCabinetButton_Result & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = xczs_inspection_robot_control::action::PressCabinetButton_Result;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const xczs_inspection_robot_control::action::PressCabinetButton_Result *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<xczs_inspection_robot_control::action::PressCabinetButton_Result *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &xczs_inspection_robot_control::action::typesupport_fastrtps_cpp::_PressCabinetButton_Result__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xczs_inspection_robot_control, action, PressCabinetButton_Result)() {
  return &xczs_inspection_robot_control::action::typesupport_fastrtps_cpp::_PressCabinetButton_Result__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_xczs_inspection_robot_control
cdr_serialize(
  const xczs_inspection_robot_control::action::PressCabinetButton_Feedback & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: phase
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  xczs_inspection_robot_control::action::PressCabinetButton_Feedback & ros_message)
{
  // Member: phase
  cdr >> ros_message.phase;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = xczs_inspection_robot_control::action::PressCabinetButton_Feedback;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const xczs_inspection_robot_control::action::PressCabinetButton_Feedback *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<xczs_inspection_robot_control::action::PressCabinetButton_Feedback *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &xczs_inspection_robot_control::action::typesupport_fastrtps_cpp::_PressCabinetButton_Feedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xczs_inspection_robot_control, action, PressCabinetButton_Feedback)() {
  return &xczs_inspection_robot_control::action::typesupport_fastrtps_cpp::_PressCabinetButton_Feedback__handle;
}
...
// functions for xczs_inspection_robot_control::action::PressCabinetButton_Goal already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_xczs_inspection_robot_control
cdr_serialize(
  const xczs_inspection_robot_control::action::PressCabinetButton_SendGoal_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  xczs_inspection_robot_control::action::PressCabinetButton_SendGoal_Request & ros_message)
{
  // Member: goal_id
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        xczs_inspection_robot_control::action::typesupport_fastrtps_cpp::max_serialized_size_PressCabinetButton_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = xczs_inspection_robot_control::action::PressCabinetButton_SendGoal_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const xczs_inspection_robot_control::action::PressCabinetButton_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<xczs_inspection_robot_control::action::PressCabinetButton_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &xczs_inspection_robot_control::action::typesupport_fastrtps_cpp::_PressCabinetButton_SendGoal_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xczs_inspection_robot_control, action, PressCabinetButton_SendGoal_Request)() {
  return &xczs_inspection_robot_control::action::typesupport_fastrtps_cpp::_PressCabinetButton_SendGoal_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_xczs_inspection_robot_control
cdr_serialize(
  const xczs_inspection_robot_control::action::PressCabinetButton_SendGoal_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: accepted
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  xczs_inspection_robot_control::action::PressCabinetButton_SendGoal_Response & ros_message)
{
  // Member: accepted
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = xczs_inspection_robot_control::action::PressCabinetButton_SendGoal_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const xczs_inspection_robot_control::action::PressCabinetButton_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<xczs_inspection_robot_control::action::PressCabinetButton_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &xczs_inspection_robot_control::action::typesupport_fastrtps_cpp::_PressCabinetButton_SendGoal_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xczs_inspection_robot_control, action, PressCabinetButton_SendGoal_Response)() {
  return &xczs_inspection_robot_control::action::typesupport_fastrtps_cpp::_PressCabinetButton_SendGoal_Response__handle;
}
...
{
  return &xczs_inspection_robot_control::action::typesupport_fastrtps_cpp::_PressCabinetButton_SendGoal__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xczs_inspection_robot_control, action, PressCabinetButton_SendGoal)() {
  return &xczs_inspection_robot_control::action::typesupport_fastrtps_cpp::_PressCabinetButton_SendGoal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_xczs_inspection_robot_control
cdr_serialize(
  const xczs_inspection_robot_control::action::PressCabinetButton_GetResult_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  xczs_inspection_robot_control::action::PressCabinetButton_GetResult_Request & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = xczs_inspection_robot_control::action::PressCabinetButton_GetResult_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const xczs_inspection_robot_control::action::PressCabinetButton_GetResult_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<xczs_inspection_robot_control::action::PressCabinetButton_GetResult_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &xczs_inspection_robot_control::action::typesupport_fastrtps_cpp::_PressCabinetButton_GetResult_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xczs_inspection_robot_control, action, PressCabinetButton_GetResult_Request)() {
  return &xczs_inspection_robot_control::action::typesupport_fastrtps_cpp::_PressCabinetButton_GetResult_Request__handle;
}
...
// forward declaration of message dependencies and their conversion functions
// functions for xczs_inspection_robot_control::action::PressCabinetButton_Result already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_xczs_inspection_robot_control
cdr_serialize(
  const xczs_inspection_robot_control::action::PressCabinetButton_GetResult_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  xczs_inspection_robot_control::action::PressCabinetButton_GetResult_Response & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        xczs_inspection_robot_control::action::typesupport_fastrtps_cpp::max_serialized_size_PressCabinetButton_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = xczs_inspection_robot_control::action::PressCabinetButton_GetResult_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const xczs_inspection_robot_control::action::PressCabinetButton_GetResult_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<xczs_inspection_robot_control::action::PressCabinetButton_GetResult_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &xczs_inspection_robot_control::action::typesupport_fastrtps_cpp::_PressCabinetButton_GetResult_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xczs_inspection_robot_control, action, PressCabinetButton_GetResult_Response)() {
  return &xczs_inspection_robot_control::action::typesupport_fastrtps_cpp::_PressCabinetButton_GetResult_Response__handle;
}
...
{
  return &xczs_inspection_robot_control::action::typesupport_fastrtps_cpp::_PressCabinetButton_GetResult__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xczs_inspection_robot_control, action, PressCabinetButton_GetResult)() {
  return &xczs_inspection_robot_control::action::typesupport_fastrtps_cpp::_PressCabinetButton_GetResult__handle;
}
...
// functions for xczs_inspection_robot_control::action::PressCabinetButton_Feedback already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_xczs_inspection_robot_control
cdr_serialize(
  const xczs_inspection_robot_control::action::PressCabinetButton_FeedbackMessage & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  xczs_inspection_robot_control::action::PressCabinetButton_FeedbackMessage & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        xczs_inspection_robot_control::action::typesupport_fastrtps_cpp::max_serialized_size_PressCabinetButton_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = xczs_inspection_robot_control::action::PressCabinetButton_FeedbackMessage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const xczs_inspection_robot_control::action::PressCabinetButton_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<xczs_inspection_robot_control::action::PressCabinetButton_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &xczs_inspection_robot_control::action::typesupport_fastrtps_cpp::_PressCabinetButton_FeedbackMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xczs_inspection_robot_control, action, PressCabinetButton_FeedbackMessage)() {
  return &xczs_inspection_robot_control::action::typesupport_fastrtps_cpp::_PressCabinetButton_FeedbackMessage__handle;
}
