...
#include "xczs_inspection_robot_control/srv/detail/manage_operation_lease__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = xczs_inspection_robot_control::srv::ManageOperationLease_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const xczs_inspection_robot_control::srv::ManageOperationLease_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<xczs_inspection_robot_control::srv::ManageOperationLease_Request *>(
    untyped_ros_message);
...
{
  return &xczs_inspection_robot_control::srv::typesupport_fastrtps_cpp::_ManageOperationLease_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = xczs_inspection_robot_control::srv::ManageOperationLease_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const xczs_inspection_robot_control::srv::ManageOperationLease_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<xczs_inspection_robot_control::srv::ManageOperationLease_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &xczs_inspection_robot_control::srv::typesupport_fastrtps_cpp::_ManageOperationLease_Response__handle;
}
...
{
  return &xczs_inspection_robot_control::srv::typesupport_fastrtps_cpp::_ManageOperationLease__handle;
}
