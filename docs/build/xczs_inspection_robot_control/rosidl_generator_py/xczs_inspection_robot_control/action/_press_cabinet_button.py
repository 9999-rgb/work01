    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'xczs_inspection_robot_control.action.PressCabinetButton_Goal')
            logger.debug(
...
class Metaclass_PressCabinetButton_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'xczs_inspection_robot_control.action.PressCabinetButton_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_PressCabinetButton_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'xczs_inspection_robot_control.action.PressCabinetButton_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class PressCabinetButton_SendGoal_Request(metaclass=Metaclass_PressCabinetButton_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'xczs_inspection_robot_control/PressCabinetButton_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['xczs_inspection_robot_control', 'action'], 'PressCabinetButton_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from xczs_inspection_robot_control.action._press_cabinet_button import PressCabinetButton_Goal
...
class Metaclass_PressCabinetButton_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'xczs_inspection_robot_control.action.PressCabinetButton_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from xczs_inspection_robot_control.action import _press_cabinet_button
...
class PressCabinetButton_SendGoal(metaclass=Metaclass_PressCabinetButton_SendGoal):
    from xczs_inspection_robot_control.action._press_cabinet_button import PressCabinetButton_SendGoal_Request as Request
    from xczs_inspection_robot_control.action._press_cabinet_button import PressCabinetButton_SendGoal_Response as Response
...
class PressCabinetButton_GetResult_Response(metaclass=Metaclass_PressCabinetButton_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'xczs_inspection_robot_control/PressCabinetButton_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['xczs_inspection_robot_control', 'action'], 'PressCabinetButton_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from xczs_inspection_robot_control.action._press_cabinet_button import PressCabinetButton_Result
...
class Metaclass_PressCabinetButton_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'xczs_inspection_robot_control.action.PressCabinetButton_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class PressCabinetButton_GetResult(metaclass=Metaclass_PressCabinetButton_GetResult):
    from xczs_inspection_robot_control.action._press_cabinet_button import PressCabinetButton_GetResult_Request as Request
    from xczs_inspection_robot_control.action._press_cabinet_button import PressCabinetButton_GetResult_Response as Response
...
class Metaclass_PressCabinetButton_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'xczs_inspection_robot_control.action.PressCabinetButton_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class PressCabinetButton_FeedbackMessage(metaclass=Metaclass_PressCabinetButton_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'xczs_inspection_robot_control/PressCabinetButton_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['xczs_inspection_robot_control', 'action'], 'PressCabinetButton_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from xczs_inspection_robot_control.action._press_cabinet_button import PressCabinetButton_Feedback
...
class PressCabinetButton(metaclass=Metaclass_PressCabinetButton):
    ...
    from xczs_inspection_robot_control.action._press_cabinet_button import PressCabinetButton_Goal as Goal
    # The result message defined in the action definition.
    from xczs_inspection_robot_control.action._press_cabinet_button import PressCabinetButton_Result as Result
    # The feedback message defined in the action definition.
    from xczs_inspection_robot_control.action._press_cabinet_button import PressCabinetButton_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from xczs_inspection_robot_control.action._press_cabinet_button import PressCabinetButton_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from xczs_inspection_robot_control.action._press_cabinet_button import PressCabinetButton_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from xczs_inspection_robot_control.action._press_cabinet_button import PressCabinetButton_FeedbackMessage as FeedbackMessage
