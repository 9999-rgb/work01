    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'xczs_inspection_robot_control.action.OperateCabinetControl_Goal')
            logger.debug(
...
class Metaclass_OperateCabinetControl_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'xczs_inspection_robot_control.action.OperateCabinetControl_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_OperateCabinetControl_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'xczs_inspection_robot_control.action.OperateCabinetControl_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class OperateCabinetControl_SendGoal_Request(metaclass=Metaclass_OperateCabinetControl_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'xczs_inspection_robot_control/OperateCabinetControl_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['xczs_inspection_robot_control', 'action'], 'OperateCabinetControl_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from xczs_inspection_robot_control.action._operate_cabinet_control import OperateCabinetControl_Goal
...
class Metaclass_OperateCabinetControl_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'xczs_inspection_robot_control.action.OperateCabinetControl_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from xczs_inspection_robot_control.action import _operate_cabinet_control
...
class OperateCabinetControl_SendGoal(metaclass=Metaclass_OperateCabinetControl_SendGoal):
    from xczs_inspection_robot_control.action._operate_cabinet_control import OperateCabinetControl_SendGoal_Request as Request
    from xczs_inspection_robot_control.action._operate_cabinet_control import OperateCabinetControl_SendGoal_Response as Response
...
class OperateCabinetControl_GetResult_Response(metaclass=Metaclass_OperateCabinetControl_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'xczs_inspection_robot_control/OperateCabinetControl_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['xczs_inspection_robot_control', 'action'], 'OperateCabinetControl_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from xczs_inspection_robot_control.action._operate_cabinet_control import OperateCabinetControl_Result
...
class Metaclass_OperateCabinetControl_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'xczs_inspection_robot_control.action.OperateCabinetControl_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class OperateCabinetControl_GetResult(metaclass=Metaclass_OperateCabinetControl_GetResult):
    from xczs_inspection_robot_control.action._operate_cabinet_control import OperateCabinetControl_GetResult_Request as Request
    from xczs_inspection_robot_control.action._operate_cabinet_control import OperateCabinetControl_GetResult_Response as Response
...
class Metaclass_OperateCabinetControl_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'xczs_inspection_robot_control.action.OperateCabinetControl_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class OperateCabinetControl_FeedbackMessage(metaclass=Metaclass_OperateCabinetControl_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'xczs_inspection_robot_control/OperateCabinetControl_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['xczs_inspection_robot_control', 'action'], 'OperateCabinetControl_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from xczs_inspection_robot_control.action._operate_cabinet_control import OperateCabinetControl_Feedback
...
class OperateCabinetControl(metaclass=Metaclass_OperateCabinetControl):
    ...
    from xczs_inspection_robot_control.action._operate_cabinet_control import OperateCabinetControl_Goal as Goal
    # The result message defined in the action definition.
    from xczs_inspection_robot_control.action._operate_cabinet_control import OperateCabinetControl_Result as Result
    # The feedback message defined in the action definition.
    from xczs_inspection_robot_control.action._operate_cabinet_control import OperateCabinetControl_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from xczs_inspection_robot_control.action._operate_cabinet_control import OperateCabinetControl_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from xczs_inspection_robot_control.action._operate_cabinet_control import OperateCabinetControl_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from xczs_inspection_robot_control.action._operate_cabinet_control import OperateCabinetControl_FeedbackMessage as FeedbackMessage
