...
bool xczs_inspection_robot_control__msg__cabinet_control_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("xczs_inspection_robot_control.msg._cabinet_control_state.CabinetControlState", full_classname_dest, 76) == 0);
  }
  xczs_inspection_robot_control__msg__CabinetControlState * ros_message = _ros_message;
  {  // header
...
PyObject * xczs_inspection_robot_control__msg__cabinet_control_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("xczs_inspection_robot_control.msg._cabinet_control_state");
