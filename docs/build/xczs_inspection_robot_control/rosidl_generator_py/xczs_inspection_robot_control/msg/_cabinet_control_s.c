...
bool xczs_inspection_robot_control__msg__cabinet_control__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("xczs_inspection_robot_control.msg._cabinet_control.CabinetControl", full_classname_dest, 65) == 0);
  }
  xczs_inspection_robot_control__msg__CabinetControl * ros_message = _ros_message;
  {  // control_id
...
PyObject * xczs_inspection_robot_control__msg__cabinet_control__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("xczs_inspection_robot_control.msg._cabinet_control");
