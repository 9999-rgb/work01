...
class Metaclass_SetCabinetGrasp(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from xczs_inspection_robot_control.srv import _set_cabinet_grasp
...
class SetCabinetGrasp(metaclass=Metaclass_SetCabinetGrasp):
    from xczs_inspection_robot_control.srv._set_cabinet_grasp import SetCabinetGrasp_Request as Request
    from xczs_inspection_robot_control.srv._set_cabinet_grasp import SetCabinetGrasp_Response as Response
