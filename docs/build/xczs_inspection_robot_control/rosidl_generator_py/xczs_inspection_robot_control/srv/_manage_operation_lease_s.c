...
bool xczs_inspection_robot_control__srv__manage_operation_lease__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("xczs_inspection_robot_control.srv._manage_operation_lease.ManageOperationLease_Request", full_classname_dest, 86) == 0);
  }
  xczs_inspection_robot_control__srv__ManageOperationLease_Request * ros_message = _ros_message;
  {  // command
...
PyObject * xczs_inspection_robot_control__srv__manage_operation_lease__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("xczs_inspection_robot_control.srv._manage_operation_lease");
...
ROSIDL_GENERATOR_C_EXPORT
bool xczs_inspection_robot_control__srv__manage_operation_lease__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("xczs_inspection_robot_control.srv._manage_operation_lease.ManageOperationLease_Response", full_classname_dest, 87) == 0);
  }
  xczs_inspection_robot_control__srv__ManageOperationLease_Response * ros_message = _ros_message;
  {  // success
