...
class Metaclass_ManageOperationLease(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from xczs_inspection_robot_control.srv import _manage_operation_lease
...
class ManageOperationLease(metaclass=Metaclass_ManageOperationLease):
    from xczs_inspection_robot_control.srv._manage_operation_lease import ManageOperationLease_Request as Request
    from xczs_inspection_robot_control.srv._manage_operation_lease import ManageOperationLease_Response as Response
