...
#include "xczs_inspection_robot_control/msg/detail/cabinet_control__rosidl_typesupport_fastrtps_c.h"
...
using _CabinetControl__ros_msg_type = xczs_inspection_robot_control__msg__CabinetControl;
...
static uint32_t _CabinetControl__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_xczs_inspection_robot_control__msg__CabinetControl(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = xczs_inspection_robot_control__msg__CabinetControl;
    is_plain =
      (
...
static size_t _CabinetControl__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_xczs_inspection_robot_control__msg__CabinetControl(
