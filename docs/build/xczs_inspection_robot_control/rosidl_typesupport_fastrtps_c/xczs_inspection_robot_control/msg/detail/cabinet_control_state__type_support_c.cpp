...
#include "xczs_inspection_robot_control/msg/detail/cabinet_control_state__rosidl_typesupport_fastrtps_c.h"
...
using _CabinetControlState__ros_msg_type = xczs_inspection_robot_control__msg__CabinetControlState;
...
size_t get_serialized_size_xczs_inspection_robot_control__msg__CabinetControlState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CabinetControlState__ros_msg_type * ros_message = static_cast<const _CabinetControlState__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _CabinetControlState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_xczs_inspection_robot_control__msg__CabinetControlState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xczs_inspection_robot_control
size_t max_serialized_size_xczs_inspection_robot_control__msg__CabinetControlState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = xczs_inspection_robot_control__msg__CabinetControlState;
    is_plain =
      (
...
static size_t _CabinetControlState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_xczs_inspection_robot_control__msg__CabinetControlState(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xczs_inspection_robot_control, msg, CabinetControlState)() {
