...
static const _SwitchToolset_Request_type_support_symbol_names_t _SwitchToolset_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xczs_inspection_robot_control, srv, SwitchToolset_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xczs_inspection_robot_control, srv, SwitchToolset_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, xczs_inspection_robot_control, srv, SwitchToolset_Request)() {
  return &::xczs_inspection_robot_control::srv::rosidl_typesupport_c::SwitchToolset_Request_message_type_support_handle;
}
...
static const _SwitchToolset_Response_type_support_symbol_names_t _SwitchToolset_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xczs_inspection_robot_control, srv, SwitchToolset_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xczs_inspection_robot_control, srv, SwitchToolset_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, xczs_inspection_robot_control, srv, SwitchToolset_Response)() {
  return &::xczs_inspection_robot_control::srv::rosidl_typesupport_c::SwitchToolset_Response_message_type_support_handle;
}
...
static const _SwitchToolset_type_support_symbol_names_t _SwitchToolset_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xczs_inspection_robot_control, srv, SwitchToolset)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xczs_inspection_robot_control, srv, SwitchToolset)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, xczs_inspection_robot_control, srv, SwitchToolset)() {
  return &::xczs_inspection_robot_control::srv::rosidl_typesupport_c::SwitchToolset_service_type_support_handle;
}
