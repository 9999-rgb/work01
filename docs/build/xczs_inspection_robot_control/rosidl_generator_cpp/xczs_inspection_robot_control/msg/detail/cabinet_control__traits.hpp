...
#ifndef XCZS_INSPECTION_ROBOT_CONTROL__MSG__DETAIL__CABINET_CONTROL__TRAITS_HPP_
#define XCZS_INSPECTION_ROBOT_CONTROL__MSG__DETAIL__CABINET_CONTROL__TRAITS_HPP_
...
inline void to_yaml(
  const xczs_inspection_robot_control::msg::CabinetControl & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const xczs_inspection_robot_control::msg::CabinetControl & msg)
{
  return xczs_inspection_robot_control::msg::to_yaml(msg);
}

template<>
inline const char * data_type<xczs_inspection_robot_control::msg::CabinetControl>()
{
  return "xczs_inspection_robot_control::msg::CabinetControl";
}

template<>
inline const char * name<xczs_inspection_robot_control::msg::CabinetControl>()
{
  return "xczs_inspection_robot_control/msg/CabinetControl";
}

template<>
struct has_fixed_size<xczs_inspection_robot_control::msg::CabinetControl>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<xczs_inspection_robot_control::msg::CabinetControl>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<xczs_inspection_robot_control::msg::CabinetControl>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // XCZS_INSPECTION_ROBOT_CONTROL__MSG__DETAIL__CABINET_CONTROL__TRAITS_HPP_
