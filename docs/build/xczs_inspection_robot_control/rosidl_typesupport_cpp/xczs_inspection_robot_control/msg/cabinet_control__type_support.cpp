...
static const _CabinetControl_type_support_symbol_names_t _CabinetControl_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xczs_inspection_robot_control, msg, CabinetControl)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, xczs_inspection_robot_control, msg, CabinetControl)),
  }
};
...
{
  return &::xczs_inspection_robot_control::msg::rosidl_typesupport_cpp::CabinetControl_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, xczs_inspection_robot_control, msg, CabinetControl)() {
  return get_message_type_support_handle<xczs_inspection_robot_control::msg::CabinetControl>();
}
